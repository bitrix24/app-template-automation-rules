  ...
  extends BaseRabbitMQ
{
    ...
    public function connect(): void {
        try {
            echo '[RabbitMQ::Producer] connect...'.PHP_EOL;
            ...
            echo '[RabbitMQ::Producer] connected successfully'.PHP_EOL;
        } catch (\Exception $e) {
            echo '[RabbitMQ::Producer] connection error: '.$e->getMessage().PHP_EOL;
            throw $e;
        }
    }
